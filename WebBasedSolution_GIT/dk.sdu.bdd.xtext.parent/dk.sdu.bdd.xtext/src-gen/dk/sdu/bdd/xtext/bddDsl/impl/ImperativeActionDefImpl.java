...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Imperative Action Def</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.bdd.xtext.bddDsl.impl.ImperativeActionDefImpl#getName <em>Name</em>}</li>
 *   <li>{@link dk.sdu.bdd.xtext.bddDsl.impl.ImperativeActionDefImpl#getPreposition <em>Preposition</em>}</li>
 *   <li>{@link dk.sdu.bdd.xtext.bddDsl.impl.ImperativeActionDefImpl#getArgument <em>Argument</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImperativeActionDefImpl extends MinimalEObjectImpl.Container implements ImperativeActionDef
{
  /**
   ...
   * @generated
   */
  protected ImperativeActionDefImpl()
  {
    super();
  }
  ...
  {
    return BddDslPackage.Literals.IMPERATIVE_ACTION_DEF;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BddDslPackage.IMPERATIVE_ACTION_DEF__NAME, oldName, name));
  }
  ...
  public void setPreposition(String newPreposition)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BddDslPackage.IMPERATIVE_ACTION_DEF__PREPOSITION, oldPreposition, preposition));
  }
  ...
  public void setArgument(String newArgument)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BddDslPackage.IMPERATIVE_ACTION_DEF__ARGUMENT, oldArgument, argument));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BddDslPackage.IMPERATIVE_ACTION_DEF__NAME:
        return getName();
      case BddDslPackage.IMPERATIVE_ACTION_DEF__PREPOSITION:
        return getPreposition();
      case BddDslPackage.IMPERATIVE_ACTION_DEF__ARGUMENT:
        return getArgument();
    }
